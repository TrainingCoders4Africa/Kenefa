...
public class Main {
    /*public static void main(String[] args) {
	 ...
	 public static void main(String ar[]){
		 System.out.println("---DataNucleus Tutorial with JPA");
	        EntityManagerFactory emf = Persistence.createEntityManagerFactory("kenefa-api");
	        String jpql="SELECT c FROM " + Country.class.getName() + " c where upper(c.id) = '" + "SN".toUpperCase() ;
	        // Create entity manager
	        EntityManager em = emf.createEntityManager();
	       System.out.println("find --: "+new FacilityDaoImpl().getDao().getResultList(jpql, null));
