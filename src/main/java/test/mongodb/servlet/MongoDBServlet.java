...
public class MongoDBServlet /*extends HttpServlet*/ {
   /* private static final String OPENSHIFT_MONGODB_DB_HOST = "127.0.0.1";
	private static final String OPENSHIFT_MONGODB_DB_PORT = "27017";
	private static final String OPENSHIFT_APP_NAME = "test";
	private Mongo mongo;
    private DB mongoDB;
